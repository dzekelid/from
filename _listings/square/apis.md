...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/from/master/_listings/square/apis.md
...
- name: Square Connect - Deletes a timecard. Deleted timecards are still accessible
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/from/master/_listings/square/v1metimecardstimecard-id-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/from/master/_listings/square/v1metimecardstimecard-id-delete-openapi.md
x-common:
- type: x-website
  url: http://square.com
- type: x-api-gallery
